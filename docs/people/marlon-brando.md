...
Its very effective to use our existing status to gain more, because status is a virtuous cycle (using the term "virtuous" unironically). The more powerful we are *perceived* to be, the more status we're [given by others](../mind-body/mimetic-theory.md#metaphysical-desire).
...
\* Mark Kavanagh on [YouTube  (opens new window)](https://www.youtube.com/watch?v=cHou3oDFP84&lc=UgzndOU_2H_Ps1A4NVB4AaABAg)

\*\* @NauvooMetro on [Reddit  (opens new window)](https://old.reddit.com/r/OldSchoolCool/comments/13m9l2b/marlon_brandon_interview_from_1989_with_some_wise/jku3ej9/)
