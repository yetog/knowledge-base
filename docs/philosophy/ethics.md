...
1. [Meta-ethics  (opens new window)](http://en.wikipedia.org/wiki/Meta-ethics): What does "right" even mean? This field is useful for analysing moral dilemmas. It has the ambition of providing a non-biased, scientific approach to judging inherently unjudgable situations.
2. [Descriptive ethics  (opens new window)](http://en.wikipedia.org/wiki/Descriptive_ethics): What do people think is right? This is the study of people's beliefs about morality at a given time and place.
...
We discussed in [The MACI Framework](#the-maci-framework), that actions are on the path: Motivation, Action, Consequences, Impacts. We can relate our new question to this framework -
...
*"The less direct influence a person has on the consequences, the more amoral the action".*
...
*When a person has an only indirect influence the consequences, the moral judgement should be in proportion to their contribution to the impact of the consequences*
...
This one is really one of the easiest to solve: *The less choice a person has, the more amoral the action*.
