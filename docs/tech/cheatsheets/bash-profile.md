...
To edit your bash\_profile just enter `nano ~/.bash_profile`. After you have saved your changes you can use `source ~/.bash_profile` to apply the changes in terminal (or simply restart terminal).
...
- Some handy commands found here: [https://gist.github.com/natelandau/10654137  (opens new window)](https://gist.github.com/natelandau/10654137)
