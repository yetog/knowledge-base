...
- Docker Swarm: [Using private registry in Docker Swarm  (opens new window)](https://codeblog.dotsandbrackets.com/private-registry-swarm/)
- Docker Swarm: [Container Orchestration with Docker Machine, Docker Stack, and Docker Swarm  (opens new window)](https://www.callicoder.com/docker-machine-swarm-stack-golang-example/)
