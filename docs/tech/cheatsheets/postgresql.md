...
- [Updating tables with dependent views  (opens new window)](https://stackoverflow.com/questions/17989355/alter-column-ignoring-dependent-views). Usage exanple:
...
- [System design hack: Postgres is a great pub/sub & job server  (opens new window)](https://hn.premii.com/#/comments/21484215)
- [Designing the most performant Row Level Security schema  (opens new window)](https://news.ycombinator.com/item?id=22331188)
- [Postgresqlco.nf: PostgreSQL Configuration for Humans  (opens new window)](https://news.ycombinator.com/item?id=22139975)
- [Pgsh – branch Postgres like Git  (opens new window)](https://hn.premii.com/#/comments/21642340)
- [Postgres Health Check and SQL Performance Analysis  (opens new window)](https://news.ycombinator.com/item?id=21464272)
- [pg\_flame – flamegraph visualizations of PostgreSQL query plans  (opens new window)](https://news.ycombinator.com/item?id=21371642)
- [More on Postgres Performance  (opens new window)](http://www.craigkerstiens.com/2013/01/10/more-on-postgres-performance/)
- [Highly Available PostgreSQL Database  (opens new window)](https://github.com/ric2b/Highly-Available-PostgreSQL-Database)
- [A user interface for Postgres EXPLAIN that also gives tips  (opens new window)](https://news.ycombinator.com/item?id=20343919)
