...
![JS Snippets](https://zaylegend.com/img/js-snippet.gif)
...
That's quite a long snippet for creating a new table in Postgres with (my) standard columns. I might soon move ID columns over to the new [Identity Type  (opens new window)](https://www.2ndquadrant.com/en/blog/postgresql-10-identity-columns/). Easier to see how this one works rather than trying to read the code:

![SQL Snippet](https://zaylegend.com/img/sql-snippet.gif)
