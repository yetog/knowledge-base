...
[Source  (opens new window)](https://css-tricks.com/debouncing-throttling-explained-examples/)
...
[Source  (opens new window)](https://github.com/jgthms/bulma/issues/451#issuecomment-331758839)
...
[Source  (opens new window)](https://dev.to/gajus/my-favorite-css-hack-32g3)
...
I'm not a big fan to the ecto `timestamps()` function since it uses "inserted\_at" rather than "created\_at" and it doesn't provide default values. Use this instead
...
[Source  (opens new window)](https://hackernoon.com/get-notified-of-user-signups-and-plan-changes-automatically-using-postgres-phoenix-pubsub-e67d061b04bc)

### Storing JSONB

[Source  (opens new window)](https://thoughtbot.com/blog/why-ecto-s-way-of-storing-embedded-lists-of-maps-makes-querying-hard)
...
[Source  (opens new window)](https://stackoverflow.com/questions/29675347/how-to-create-trigger-for-all-table-in-postgresql)
